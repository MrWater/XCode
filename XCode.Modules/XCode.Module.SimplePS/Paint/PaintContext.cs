...
namespace XCode.Module.SimplePS.Common.Paint
{
    ...
    internal class PaintContext
    {
        ...
        /// 当前操作图层
        /// </summary>
        public LayerGroup OperationLayers { get; private set; }

        /// <summary>
        /// 历史图层个数
        /// </summary>
        public int HistoryLayerCnt { get; set; }

        private Dictionary<string, Cursor> _cursor;
        private Dictionary<string, ToolType> _toolType;
        private Dictionary<string, PaintToolBase> _paintTool;
